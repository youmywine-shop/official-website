...
ob_start();
$template = array();
$template['title'] = 'YOUMYWINE | Amministrazione | Prodotti | Aggiungi';
$template['content'] = '';
...
$prodotto = array();
$prodotto['id_prodotto']='0';
$prodotto['nome'] = '';
$prodotto['descrizione'] = '';
$prodotto['prezzo'] = '';
$prodotto['id_categoria'] = '0';
$prodotto['id_location'] = '0';
...
if(array_key_exists('aggiungi', $_POST)){
    ...
    if( !count($error) ){
        ...
        $prodotto['id_prodotto'] = $Prodotti->aggiungi_prodotto($prodotto);
        
        if( $prodotto['id_prodotto'] && load_image('../images/img_prodotti/', $_FILES['immagine'], $prodotto['id_prodotto']) ){
...
<form id="frm_add_prodotto" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" >
    ...
    <p>
        <button type="submit" name="aggiungi" id="aggiungi">crea prodotto</button>
    </p>
